...
- **`05_INVENTORIES.md`** — asset 의존 맵에 `abap-lesson-viewer.*`·`abap-glossary.*` 추가, D절에 orphan `_abap-curriculum-gallery.html`·`lesson-viewer.html`·초기 `lesson-content/THEORY-01-M01.html` 기록, E절에 `abap_glossary.json`·`abap_curriculum_20260529_180000.json` 추가.
