...
>
> ⚠️ **2026-06-16 기준선 리셋**: DoD를 상향(T-code 노출 + 코드 실습 시뮬레이션 필수)했다. 이전 라운드에서 "완료"로 찍혔던 Lesson(구 Chapter 1~4 포함)은 **새 DoD를 충족하지 못하므로 전부 미착수로 되돌렸다**. [02_PROGRESS](02_PROGRESS.md)에서 0부터 다시 진행한다.
