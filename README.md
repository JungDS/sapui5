...
| 구분 | 문서 | 링크 |
|---|---|---|
| 완료 | 🎉 **ABAP Track 1 완성** — THEORY-01~21 **137개 Lesson 본문 전부 작성**(Lesson Single Viewer). 글로서리 348개 용어 완전 패리티(미정의 0건). THEORY-19~21 포함 137개 전체 파일에 네이비 Editor 서식 적용 및 인라인 스타일 분리(CSS 클래스 아키텍처 리팩토링) 완료. 다음은 Track 2(PRACTICAL-*) | https://github.com/JungDS/sapui5/pull/50 |
